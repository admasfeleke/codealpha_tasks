# CodeAlpha Tasks — Data Science Internship

**Intern:** Admasu Feleke Mulatu (CA/DF1/268581)
**Domain:** Data Science
**Batch:** September 2026 (10 Sep – 10 Oct 2026)
...
```
Python 3.14+ recommended. Each task lives in its own folder with its own README and outputs.

## Repo naming note
CodeAlpha asks for a repo named `codealpha_tasks` — rename this repository to that when pushing to GitHub.
